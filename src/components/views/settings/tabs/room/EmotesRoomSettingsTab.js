...
export default class EmotesRoomSettingsTab extends React.Component {
    ...
    _loadEmotePacks() {
        ...
        const emoteRooms = client.getAccountData('minority.destroyer.emote_rooms');
        let emoteRoomsThis = {};
        ...
        if (thisRoom) {
            ...
            this.setState({
                ...
                "canEdit": thisRoom.currentState.mayClientSendStateEvent('minority.destroyer.room_emotes', client),
            });
        }
    }
    ...
    _onEmoteRoomToggle(pack) {
        ...
        client.setAccountData('minority.destroyer.emote_rooms', emoteRoomsContent).then(() => {
            this._loadEmotePacks();
